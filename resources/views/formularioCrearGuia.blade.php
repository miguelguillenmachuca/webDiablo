  ...
  <div id="main" class="container">
    ...
    <form name="formGuia" id="formGuia" class="formGuia" action="formularioCrearGuia.php" method="post">
      ...
      <div class="container-fluid">
        ...
        <div class="form-group" id="seccionDescripcion">
        ...
        <div class="form-group" id="seccionVideo">
        ...
        <div class="form-group" id="seccionVisibilidad">
        ...
        <div class="margen-inf" id="seccionBotones">
